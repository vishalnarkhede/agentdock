...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  {
    id: "plan-inline-comment",
    title: "Comment directly on the plan",
    body: "Select any text in the plan — a \"+ add comment\" button appears. Write your note, hit Enter, then send it to Claude in one batch.",
    target: "@plan-comment-area",
    position: "top",
    padding: 4,
  },
  {
  ...
  {
    id: "diff-inline-comment",
    title: "Comment on any changed line",
    body: "Click any diff line (or drag to select multiple) to open an inline comment box — the selected code becomes context for your note.",
    target: "@diff-file-content",
    position: "top",
    padding: 4,
  },
  {
